import { deleteReservationOnServerByPaymentId, fetchHiddenReservationIds, fetchStoredReservations, fetchReservationConfirmation, fetchUpcomingReservations, fetchPastReservations, hideReservationLocally, removeStoredReservation } from "../Core/api.js";
...
function isReservationHidden(hiddenReservationIds, paymentReservationId) {
...
function getReservationSeatText(reservation) {
...
export async function renderSavedReservations() {
    ...
    const deleteButtons = mainSection.querySelectorAll("[data-delete-reservation-id]");
